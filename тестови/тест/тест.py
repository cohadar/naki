...
from наки.интервали import ТабелаИнтервала
from наки.запис import ТабелаЗаписа
...
class ТестВежбањеЗидар(ВежбањеЗидар):
    ...
    def т_интервала(бре, путања):
        return ТабелаИнтервала(бре.tsv(бре.интервали), путања)

    def т_карти(бре, путања):
        return ТабелаКарти(бре.tsv(бре.карте), путања)

    def т_линкова(бре, путања):
        return ТабелаЛинкова(бре.tsv(бре.линкови), путања)

    def т_записа(бре, путања):
        return ТабелаЗаписа(бре.tsv(бре.запис), путања)

    def tsv(бре, на_диску):
        return ТестTSV(на_диску)
