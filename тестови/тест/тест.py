...
class ТестШпилКонтејнер(ШпилКонтејнер):
    def __init__(к, дир, лен):
        ...
        к.т_интервала.override(
            providers.Factory(Табела, путања=к.путања_интервали, Тип=Интервали, на_диску=д_интервали))
        к.т_карти.override(
            providers.Factory(Табела, путања=к.путања_карте, Тип=Карта, на_диску=д_карте))
        к.т_линкова.override(
            providers.Factory(Табела, путања=к.путања_линкови, Тип=Линк, на_диску=д_линкови))
        к.т_записа.override(
            providers.Factory(Табела, путања=к.путања_запис, Тип=Запис, на_диску=д_запис))
