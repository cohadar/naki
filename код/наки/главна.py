class Главна():
    def __init__(бре, ui, шпилови):
        ...
        for индекс in range(1, len(бре.шпилови) + 1):
            бре.ui.на_индекс(бре.а_индекс, индекс=индекс)

    def а_прекид(бре):
        бре.прекид = True

    def а_избаци_промашене(бре):
        for в in бре.шпилови:
            в.избаци_промашене()

    def а_задржи_само_промашене(бре):
        for в in бре.шпилови:
    ...
    def а_индекс(бре, индекс):
        бре.шпилови[int(индекс) - 1]()
