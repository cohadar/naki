...
class ШпилUI():
    def __init__(бре, терминал, регистар_питање, регистар_одговор):
        бре.т = терминал
        бре._претходни_текст = None
        бре._зелено = False
        бре._регистар_питање = регистар_питање
        бре._регистар_одговор = регистар_одговор

    def на_прекид(бре, фунц):
        бре._регистар_питање.региструј(КОМАНДА_ПРЕКИД, фунц)

    def на_отвори_урл(бре, фунц, **парамс):
        бре._регистар_питање.региструј(КОМАНДА_ОТВОРИ_УРЛ, фунц, **парамс)

    def на_едитуј(бре, фунц, **парамс):
        бре._регистар_питање.региструј(КОМАНДА_ЕДИТУЈ, фунц, **парамс)
                ...
                with бре.т.главни():
                    ...
                    if промена_врсте:
                        if к in КОМАНДА_ФЕЈЛ or к in КОМАНДА_ПЛУС1 or к in КОМАНДА_ПЛУС2:
                            ...
                            return False
                    return not бре._регистар_питање.изврши(к, **дата)
