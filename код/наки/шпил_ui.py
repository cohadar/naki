...
class ШпилUI():
    def __init__(бре, терминал, регистар_питање, регистар_одговор):
        ...
        бре._зелено = False
        бре.регистар_питање = регистар_питање
        бре.регистар_одговор = регистар_одговор
                ...
                with бре.т.главни():
                    ...
                    if промена_врсте:
                        if к in КОМАНДА_ФЕЈЛ or к in КОМАНДА_ПЛУС1 or к in КОМАНДА_ПЛУС2:
                            ...
                            return False
                    return not бре.регистар_питање.изврши(к, **дата)
            ...
            with бре.т.сакривен_курсор():
                ...
                with бре.т.главни():
                    ...
                    with бре.т.статус():
                        ...
                        к = бре.т.инпут_код()
                        if бре.регистар_одговор.изврши(к, **дата):
                            return
                        бре.т.звук_грешке()
