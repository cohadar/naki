...
class ВежбањеЗидар():
    ...
    def п_интервала(бре, путања):
        return ПогледИнтервала(ТабелаИнтервала(путања))

    def п_карти(бре, путања):
        return ПогледКарти(ТабелаКарти(путања))

    def п_линкова(бре, путања):
        return ПогледЛинкова(ТабелаЛинкова(путања))

    def п_записа(бре, путања):
        return ПогледЗаписа(ТабелаЗаписа(путања))
...
def main():
    ...
    г1 = гк.главна()
    гз = ГлавнаЗидар(каталог)
    г2 = гз.главна()
    print(г1)
    print(г2)
    assert str(г1) == str(г2)
