...
class Шпил():
    def __init__(бре, питање_ui, одговор_ui, дир, п_интервала, п_карти, п_линкова, п_записа):
        бре._питање_ui = питање_ui
        бре._одговор_ui = одговор_ui
        assert бре._питање_ui.стање == бре._одговор_ui.стање
        бре._дир = дир
        ...
        бре._питање_ui.на_прекид(бре.а_прекид)
        бре._питање_ui.на_отвори_урл(бре.а_отвори_урл, урл=None, ui=бре._питање_ui)
        бре._питање_ui.на_едитуј(бре.а_измени, извор=None, линија=None, ui=бре._питање_ui)
        бре._одговор_ui.на_прекид(бре.а_прекид)
        бре._одговор_ui.на_отвори_урл(бре.а_отвори_урл, урл=None, ui=бре._одговор_ui)
        бре._одговор_ui.на_едитуј(бре.а_измени, извор=None, линија=None, ui=бре._одговор_ui)
        бре._одговор_ui.на_фејл(бре.а_оцена, ид=None, оцена=0)
        бре._одговор_ui.на_плус1(бре.а_оцена, ид=None, оцена=1)
        бре._одговор_ui.на_плус2(бре.а_оцена, ид=None, оцена=2)
    ...
    def а_отвори_урл(бре, ui, урл):
        ui.отвори_урл(урл)

    def а_измени(бре, ui, извор, линија):
    ...
    def __call__(бре):
        for карта in бре.п_карти:
            ...
            while бре.понови_питање:
                покажи_одговор = бре._питање_ui.питање(дата, наслов, питање, број_карата)
                if покажи_одговор:
                    break
            if бре.прекид:
                break
            while бре.понови_одговор:
                бре._одговор_ui.одговор(дата, наслов, питање, одговор, број_карата)
            if бре.прекид:
                break
        бре.clear()
        return бре.сиже()
