...
class Шпил():
    def __init__(бре, питање_ui, одговор_ui, дир, п_интервала, п_карти, п_линкова, п_записа):
        ...
        регистар_одговор = бре._одговор_ui._регистар_одговор
        регистар_одговор.региструј(КОМАНДА_ПРЕКИД, бре.а_прекид)
        регистар_одговор.региструј(КОМАНДА_ОТВОРИ_УРЛ, бре.а_отвори_урл, урл=None, ui=бре._одговор_ui)
        регистар_одговор.региструј(КОМАНДА_ЕДИТУЈ, бре.а_измени, извор=None, линија=None, ui=бре._одговор_ui)
