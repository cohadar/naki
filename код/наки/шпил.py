...
class Шпил():
    def __init__(бре, ui, дир, п_интервала, п_карти, п_линкова, п_записа):
        ...
        бре._ui.на_отвори_урл(бре.а_отвори_урл, урл=None, ui=бре._ui)
        бре._ui.на_едитуј(бре.а_измени, извор=None, линија=None, ui=бре._ui)
        регистар_одговор = бре._ui._регистар_одговор
        регистар_одговор.региструј(КОМАНДА_ПРЕКИД, бре.а_прекид)
        регистар_одговор.региструј(КОМАНДА_ОТВОРИ_УРЛ, бре.а_отвори_урл, урл=None, ui=бре._ui)
        регистар_одговор.региструј(КОМАНДА_ЕДИТУЈ, бре.а_измени, извор=None, линија=None, ui=бре._ui)
