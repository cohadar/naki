...
class Регистар():
    ...
    def региструј(бре, команда, акција):
...
def команда_индекс(број_елемената):
    return Команда([str(и) for и in range(1, број_елемената + 1)])
...
КОМАНДА_ЗАДРЖИ_САМО_ПРОМАШЕНЕ = Команда([КОД_ЦИР_Р, КОД_ЛАТ_Р])
