...
class UI():
    ...
    def питање(бре, путања_каталога, наслов, питање, одговор, извор, линија, број_преосталих_карата, урл):
        бре.т.обриши()
        with бре.т.главни():
    ...
    def одговор(бре, путања_каталога, наслов, питање, одговор, извор, линија, број_преосталих_карата, урл):
        бре.т.обриши()
        with бре.т.главни():
            бре._принт_питање(наслов, питање, број_преосталих_карата)
