...
class Вежбање():
    ...
    def __call__(бре, ui):
        ...
        for карта in бре.шпил:
            ...
            прекид = ui.питање(бре.путања_каталога, наслов, питање, одговор, извор, линија, број_карата, урл)
            if прекид:
                break
            прекид, оцена = ui.одговор(бре.путања_каталога, наслов, питање, одговор, извор, линија, број_карата, урл)
            if прекид:
                break
